ShopifyApp.configure do |config|
  ...
  config.webhooks = [
    { topic: 'app/uninstalled', address: 'https://brands-app-1.herokuapp.com/hooks/delete_page', format: 'json' },
    { topic: 'products/create', address: 'https://brands-app-1.herokuapp.com/hooks/get_vendors', format: 'json' }
  ]
end
